...
import { getSessionActivity, isCreditLimitError, SESSION_ACTIVITY_COLOR } from "@/components/shared/session-activity";
...
export function BoardCard({
	...
	const rawSessionActivity = useMemo(() => getSessionActivity(sessionSummary), [sessionSummary]);
	const lastSessionActivityRef = useRef<SessionActivity | null>(null);
	...
	const isCreditLimit = isCreditLimitError(sessionSummary);
